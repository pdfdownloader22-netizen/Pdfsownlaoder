...
async def process_url(
    ...
    try:
        ...
        # Keep the SAME Telegram progress message while the file is uploaded.
        # PTB does not expose a reliable upload-percentage callback for
        # send_document/send_video, so the upload stage is shown honestly
